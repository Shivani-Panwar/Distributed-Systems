...
private static java.util.Hashtable _methods = new java.util.Hashtable ();
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // corba/Library/removeItem
       {
         String managerID = in.read_string ();
         String itemID = in.read_string ();
         int quantity = in.read_long ();
       ...
       case 2:  // corba/Library/listItemAvailability
       {
         String managerID = in.read_string ();
         String $result = null;
       ...
       case 3:  // corba/Library/borrowItem
       {
       ...
       case 5:  // corba/Library/returnItem
       {
         String userID = in.read_string ();
         String itemID = in.read_string ();
         boolean $result = false;
       ...
       case 6:  // corba/Library/addToQueue
       {
         String itemID = in.read_string ();
         String userID = in.read_string ();
         boolean $result = false;
       ...
       case 7:  // corba/Library/exchangeItem
       {
         String userID = in.read_string ();
       ...
       case 8:  // corba/Library/checkAvailability
       {
         String itemID = in.read_string ();
         boolean $result = false;
       ...
       case 9:  // corba/Library/checkBorrowPossible
       {
         String userID = in.read_string ();
         String itemID = in.read_string ();
         boolean $result = false;
       ...
       case 10:  // corba/Library/checkReturnPossible
       {
         String userID = in.read_string ();
         String itemID = in.read_string ();
         boolean $result = false;
       ...
       case 11:  // corba/Library/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
