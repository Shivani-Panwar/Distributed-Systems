...
/**
* MontrealLibraryServer/MontrealPOA.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from MontrealLibraryServer.idl
* Saturday, March 2, 2019 2:20:01 o'clock AM EST
*/

public abstract class MontrealPOA extends org.omg.PortableServer.Servant
 implements MontrealOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // MontrealLibraryServer/Montreal/addItem
       {
       ...
       case 1:  // MontrealLibraryServer/Montreal/removeItem
       {
         String managerID = in.read_string ();
         String itemID = in.read_string ();
         int quantity = in.read_long ();
       ...
       case 2:  // MontrealLibraryServer/Montreal/listItemAvailability
       {
         String managerID = in.read_string ();
         String $result = null;
       ...
       case 3:  // MontrealLibraryServer/Montreal/borrowItem
       {
       ...
       case 4:  // MontrealLibraryServer/Montreal/findItem
       {
         String userID = in.read_string ();
         String itemName = in.read_string ();
         String $result = null;
       ...
       case 5:  // MontrealLibraryServer/Montreal/returnItem
       {
         String userID = in.read_string ();
         String itemID = in.read_string ();
         boolean $result = false;
       ...
       case 6:  // MontrealLibraryServer/Montreal/addToQueue
       {
         String itemID = in.read_string ();
         String userID = in.read_string ();
         boolean $result = false;
       ...
       case 7:  // MontrealLibraryServer/Montreal/exchangeItem
       {
         String userID = in.read_string ();
       ...
       case 8:  // MontrealLibraryServer/Montreal/checkAvailability
       {
         String itemID = in.read_string ();
         boolean $result = false;
       ...
       case 9:  // MontrealLibraryServer/Montreal/checkBorrowPossible
       {
         String userID = in.read_string ();
         String itemID = in.read_string ();
         boolean $result = false;
       ...
       case 10:  // MontrealLibraryServer/Montreal/checkReturnPossible
       {
         String userID = in.read_string ();
         String itemID = in.read_string ();
         boolean $result = false;
       ...
       case 11:  // MontrealLibraryServer/Montreal/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
  ...
  private static String[] __ids = {
    "IDL:MontrealLibraryServer/Montreal:1.0"};
  ...
  public Montreal _this() 
  {
    return MontrealHelper.narrow(
    super._this_object());
  }

  public Montreal _this(org.omg.CORBA.ORB orb) 
  {
    return MontrealHelper.narrow(
