...
public class Constants {
	...
	public static final int OWN_SERVER_UDP_PORT = 9998;
	public static final int OTHER_SERVER_UDP_PORT_I = 9996;
	public static final int OTHER_SERVER_UDP_PORT_II = 9997;
